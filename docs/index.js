	...
	*/
	...
	const Slot = ({ name = DEFAULT_SLOT_NAME, children: fallback, ...bindProps }) => {
	    ...
	    return slotContent && (!Array.isArray(slotContent) || slotContent.length)
	        ? React__default['default'].Children.map(slotContent, (child) => {
	...
	const SimpleButton = SlotHost((props) => {
	    return (React__default['default'].createElement("button", Object.assign({}, props),
	        React__default['default'].createElement(Slot, null, "Default Button Text")));
	});

	const CodeExample = SlotHost(({ title, className, ...props }) => {
	    return (React__default['default'].createElement("div", Object.assign({ className: `code-example ${className || ""}` }, props),
	        React__default['default'].createElement("div", null,
	            ...
	            React__default['default'].createElement("pre", null,
	                React__default['default'].createElement("code", null,
	                    React__default['default'].createElement(Slot, null)))),
	        React__default['default'].createElement(IfSlotAssigned, { name: "result" },
	            React__default['default'].createElement("div", null,
	                React__default['default'].createElement("h4", null, "Result:"),
	                React__default['default'].createElement(Slot, { name: "result" })))));
	});

	const DemoContainer = SlotHost(({ summary, ...props }) => {
	    return (React__default['default'].createElement("details", Object.assign({}, props),
	        React__default['default'].createElement("summary", null, summary),
	        React__default['default'].createElement(CodeExample, { title: "Component Code:" },
	            React__default['default'].createElement(Slot, { name: "component-code" })),
	        React__default['default'].createElement(Slot, null)));
	});

	const PageLayout = ({ className, ...props }) => {
	    return (React__default['default'].createElement("div", Object.assign({ className: `page-layout ${className || ""}` }, props),
	        React__default['default'].createElement("header", null,
	            React__default['default'].createElement(Slot, { name: "header" }, "Default Header")),
	        React__default['default'].createElement("div", { className: "content" },
	            React__default['default'].createElement("main", null,
	                React__default['default'].createElement(Slot, null)),
	            React__default['default'].createElement("aside", null,
	                React__default['default'].createElement(Slot, { name: "aside" }, "Default aside"))),
	        React__default['default'].createElement(IfSlotAssigned, { name: "footer" },
	            React__default['default'].createElement("footer", null,
	                React__default['default'].createElement(Slot, { name: "footer" })))));
	};
	var PageLayout$1 = SlotHost(PageLayout);

	class ClassComponent extends React__default['default'].Component {
	    render() {
	        return (React__default['default'].createElement("div", null,
	            React__default['default'].createElement("div", null,
	                "Foo: ",
	                React__default['default'].createElement(Slot, { name: "foo" })),
	            React__default['default'].createElement("div", null,
	                "Bar: ",
	                React__default['default'].createElement(Slot, { name: "bar" }))));
	    }
	}
	var ClassComponent$1 = SlotHost(ClassComponent);

	const DataProvider = ({ className, ...props }) => {
	    const user = { id: 1234, name: "Nina Conti" };
	    return (React__default['default'].createElement("div", Object.assign({ className: `page-layout ${className || ""}` }, props),
	        React__default['default'].createElement(Slot, { name: "header", user: user, foo: "bar" }),
	        React__default['default'].createElement(Slot, { name: "footer", user: user, bing: "baz" })));
	};
	var DataProvider$1 = SlotHost(DataProvider);

	const trimFirst = (str) => str.slice(1);
	const ReactSlotsDemo = () => (React__default['default'].createElement("div", null,
	    React__default['default'].createElement("h1", null, "React Slots Component Demo"),
	    React__default['default'].createElement(DemoContainer, { summary: "Simple Button" },
	        React__default['default'].createElement(Template, { slot: "component-code" }, trimFirst(`
...
export default SlotHost(SimpleButton)`)),
	        React__default['default'].createElement(CodeExample, { title: "Simple Usage:" },
	            `<SimpleButton />`,
	            React__default['default'].createElement(SimpleButton, { slot: "result" })),
	        React__default['default'].createElement(CodeExample, { title: "Full Usage:" },
	            `<SimpleButton>Click Me!</SimpleButton>`,
	            React__default['default'].createElement(SimpleButton, { slot: "result" }, "Click Me!"))),
	    React__default['default'].createElement(DemoContainer, { summary: "Page Layout" },
	        React__default['default'].createElement(Template, { slot: "component-code" }, trimFirst(`
const PageLayout = () => {
  return (
    <div>
...
export default SlotHost(PageLayout)`)),
	        React__default['default'].createElement(CodeExample, { title: "Simple Usage:" },
	            ...
	            React__default['default'].createElement(PageLayout$1, { slot: "result" }, "Main Content")),
	        React__default['default'].createElement(CodeExample, { title: "Full Usage:" },
	            trimFirst(`
<PageLayout>
    ...
    <div slot="footer">Footer navigation, contact info</div>
	            ...
	            React__default['default'].createElement(PageLayout$1, { slot: "result" },
	                React__default['default'].createElement("span", { slot: "header" }, "Logo and primary navigation"),
	                React__default['default'].createElement("p", null, "Main content"),
	                React__default['default'].createElement(SimpleButton, null, "Deeply nested button!"),
	                React__default['default'].createElement("span", { slot: "aside" }, "Side navigation, advertisements"),
	                React__default['default'].createElement("div", { slot: "footer" }, "Footer navigation, contact info")))),
	    React__default['default'].createElement(DemoContainer, { summary: "Class Component" },
	        React__default['default'].createElement(Template, { slot: "component-code" }, trimFirst(`
...
export default SlotHost(ClassComponent)`)),
	        React__default['default'].createElement(CodeExample, { title: "Usage:" },
	            trimFirst(`
<ClassComponent>
  <b slot="foo">I AM FOO</b>
  <i slot="bar">I AM BAR</i>
</ClassComponent>`),
	            React__default['default'].createElement(ClassComponent$1, { slot: "result" },
	                React__default['default'].createElement("b", { slot: "foo" }, "I AM FOO"),
	                React__default['default'].createElement("i", { slot: "bar" }, "I AM BAR")))),
	    React__default['default'].createElement(DemoContainer, { summary: "Advanced: Passing custom data to slots" },
	        React__default['default'].createElement(Template, { slot: "component-code" }, trimFirst(`
const DataProvider = () => {
  const user = { id: 1234, name: "Nina Conti" };
  return (
...
<DataProvider>
  ...
  <footer slot="footer">
    {({ user, bing }) => (
      <div>
        Hello {user.name}! The BING is {bing}.
	            ...
	            React__default['default'].createElement(DataProvider$1, { slot: "result" },
	                React__default['default'].createElement("header", { slot: "header" }, ({ user, foo }) => (React__default['default'].createElement("div", null,
	                    "Hello ",
	                    user.name,
	                    "! The FOO is ",
	                    foo,
	                    "."))),
	                React__default['default'].createElement("footer", { slot: "footer" }, ({ user, bing }) => (React__default['default'].createElement("div", null,
	                    "Hello ",
	                    user.name,
	                    "! The BING is ",
	                    bing,
	...
	reactDom.render(React__default['default'].createElement(ReactSlotsDemo, null), document.getElementById("root"));
